...
function tracing9() {
  ...
  let returnVal = f(arg3, arg1, arg2);
  console.assert(returnVal === "xyz", "returnVal should be xyz");

  arg1 = "z", arg2 = "x", arg3 = "y";
  returnVal = f(arg2, arg3, arg1);
  console.assert(returnVal === "xyz", "returnVal should be xyz");
...
const writeTestCases1 = [
  { name: 'first', args: [4,1], expected: 5 },
  ...
  { name: 'fifth', args: [-1,5], expected: 4 }, // create your own test case!
  { name: 'sixth', args: [1000,5], expected: 1005 }, // create your own test case!
];
...
const writeTestCases2 = [
  ...
  { name: 'second', args: [-5,10], expected: -15 },
  ...
  { name: 'fifth', args: [90,20], expected: 70 }, // create your own test case!
  { name: 'sixth', args: [40,10], expected: 30 }, // create your own test case!
];
...
const writeTestCases3 = [
  ...
  { name: 'second', args: [5,1], expected: 5 },
  ...
  { name: 'fifth', args: [100,0], expected: 0 }, // create your own test case!
  { name: 'sixth', args: [-1,5], expected: -5 }, // create your own test case!
];
...
const writeTestCases4 = [
  ...
  { name: 'sixth', args: ['y', 'z', 'x'], expected: 'xyz' }, // create your own test case!
];
...
const writeTestCases5 = [
  ...
  { name: 'fifth', args: ['x','z','y'], expected: 'zyx' }, // create your own test case!
  { name: 'sixth', args: ['y', 'z', 'x'], expected: 'zxy' }, // create your own test case!
];
